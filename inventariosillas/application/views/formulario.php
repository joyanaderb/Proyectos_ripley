...
<div class="wrapper">
			...
			<ul class="sidebar-menu">
				...
				<li class="<?php echo $this->uri->segment(2) === "prestamos" ? 'active' : '' ?> treeview">
		          	...
		          	<ul class="treeview-menu">
                        ...
                        <li class="<?php echo $this->uri->segment(3) === "all" ? 'active' : '' ?>"><a href="<?php echo base_url(); ?>backend/prestamos/Documentacion"><i class="fa fa-circle-o"></i> Documentación</a></li>
		          	</ul>
		        </li>
	...
	<form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label  class="col-sm-3 control-label" for="nombre">Nombre ejecutivo:</label>
                    <div class="col-sm-4">
                        <input type="file" name="upload">
                        <input type="text" class="form-control" name="rut" placeholder="RUT EJ: 18979626-9" required/>
