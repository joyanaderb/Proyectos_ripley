                    ...
                    <table id="example" class="table table-bordered table-dataTables">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <td>
                                                 <?php echo $datos->nombreSuper; ?>
                        </td>
                          <td><a href="<?php echo base_url(); ?>uploads/<?php echo $datos->rut; ?>.pdf" class="btn btn-success" download="Documento <?php echo $datos->rut; ?>" >Descargar</a></td>
