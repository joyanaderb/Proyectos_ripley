...
class Availability {
    ...
    public function get_available_hours($date, $service, $provider, $exclude_appointment_id = NULL)
    {
        ...
        return $this->consider_book_advance_timeout($date, $available_hours, $provider, $service);
    }
     ...
     * @throws Exception
     */
    protected function consider_book_advance_timeout($selected_date, $available_hours, $provider, $service)
        ...
        
    {
        ...
        $book_advance_timeout = $this->CI->services_model->get_setting($service);
