...
$(document).ready(function(){
  ...
  // Initialize select2
  $("#select-filter-item").select2();

  // Read selected option
  $('#but_read').click(function(){
    var username = $('#select-filter-item option:selected').text();
    var userid = $('#select-filter-item').val();
    ...
    <div class="row" id="calendar-toolbar">
        ...
        <div id="calendar-actions" class="col-12 col-sm-7">
            ...
            <?php if ($calendar_view === 'default'): ?>
                <a class="btn btn-light" href="<?= site_url('backend/agendamientoglobal') ?>"
                   data-tippy-content="<?= lang('table') ?>">
                    <i >VER AGENDA COMPLETA</i>
                </a>
            <?php endif ?>
