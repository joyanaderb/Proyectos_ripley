...
<head>
    ...
    <title><?= isset($page_title) ? $page_title : lang('backend_section') ?> | ADMIN</title>
...
<nav id="header" class="navbar navbar-expand-md navbar-dark">
    <div id="header-logo" class="navbar-brand">
        ...
        <h6>RIPLEY CCR - LOGÍSTICA</h6>
        <small>SECCIÓN ADMINISTRADORES LOGÍSTICA</small>
    </div>
    ...
    <div id="header-menu" class="collapse navbar-collapse flex-row-reverse">
        <ul class="navbar-nav">
            ...
            <li class="nav-item <?= $active . $hidden ?>" hidden>
