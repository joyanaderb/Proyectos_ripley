<html lang="en">
<head>
    <title>Retiro agendado con éxito | RIPLEY CCR</title>
</head>
<body style="font: 13px arial, helvetica, tahoma;">
<div class="email-container" style="width: 650px; border: 1px solid #eee;">
    <div id="header" style="background-color: #70578b; height: 45px; padding: 10px 15px;">
        <strong id="logo" style="color: white; font-size: 20px; margin-top: 10px; display: inline-block">
            Logística - CCR RIPLEY
        </strong>
    </div>

    <div id="content" style="padding: 10px 15px;">
        <h2>Su retiro a sido agendado exitosamente</h2>
        <p>Hola! , a continuación te enviamos los detalles del retiro agendado:</p>
        ...
        <table id="customer-details">
            ...
            <tr>
                <td class="label" style="padding: 3px;font-weight: bold;"><?= lang('name') ?></td>
                <td style="padding: 3px;"><?= $last_name ?></td>
            </tr>
            <tr>
        ...
        <h2>Para cancelar la solicitud, da click en el siguiente enlace</h2>
    ...
    <div id="footer" style="padding: 10px; text-align: center; margin-top: 10px;
        ...
        Logística
        <a href="www.ripley.cl" style="text-decoration: none;">Ripley Chile</a>
        |
