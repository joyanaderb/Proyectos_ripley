			...
			<ul class="sidebar-menu">
				...
				<li class="<?php echo $this->uri->segment(2) === "prestamos" ? 'active' : '' ?> treeview">
		          	...
		          	<ul class="treeview-menu">
                        ...
                        <li class="<?php echo $this->uri->segment(3) === "all" ? 'active' : '' ?>"><a href="<?php echo base_url(); ?>subir_controller"><i class="fa fa-circle-o"></i>Subir Documento</a></li>
                         <li class="<?php echo $this->uri->segment(3) === "all" ? 'active' : '' ?>"><a href="<?php echo base_url(); ?>subir_controller/Documentos_cargados"><i class="fa fa-circle-o"></i>Documentos cargados</a></li>
		          	</ul>
		        </li>
	...
	<div class="content-wrapper">
       ...
       <form action="<?=base_url("subir_controller/subir")?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label  class="col-sm-3 control-label" for="nombre">DOCUMENTACIÓN DE ASIGNACIÓN</label>
                    <div class="col-sm-4">
                        Subir un fichero: <input type="file" name="userfile" value="fichero"/>
                        <div class="form-group">
                      <input type="hidden" name="idLector">
                        <input type="text" class="form-control" id="dni" placeholder="RUT" name="rut" required/>
                        ...
                        <input type="text" class="form-control" id="nombres" name="nombres" required />
                         ...
                         <label  class="col-sm-3 control-label" for="nombre">Cargo:</label>
                        ...
                        <input type="text" class="form-control" id="nombreSuper" name="nombreSuper" required />
