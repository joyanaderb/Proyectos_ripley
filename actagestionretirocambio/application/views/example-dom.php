...
<!-- Required Javascript -->
       <link rel="stylesheet" href="<?php echo base_url(); ?>application/views/bootstrap-treeview.css" > 
   <script type="text/javascript"  src="<?php echo base_url(); ?>application/views/bootstrap-treeview.js"></script>     
