...
{}
  <title>Confirmación recepción turnos CCR</title>
 ...
 <script src="<?php echo base_url(); ?>assets/js/demo/bootstrap-table.js"></script>
    
  <!--  Just for demo purpose, do not include in your project   -->
  <script src="<?php echo base_url(); ?>assets/js/demo/gsdk-switch.js"></script>
  <script src="<?php echo base_url(); ?>assets/js/demo/jquery.sharrre.js"></script>
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <div class="description">
          <h2>Confirmación recepción de turnos CCR</h2>
        </div>
        ...
        -->
          <div class="toolbar">
            <button id="alertBtn" class="btn btn-default">Confirmación H.EXTRAS</button>
          </div>
    ...
    counter-increment: tableCount; 
          ...
          <table id="fresh-table" class="table">
            ...
            <thead>
              ...
              <th data-field="country" data-sortable="true">Área Laboral </th>
              <th data-field="actions" data-formatter="activo" data-events="operateEvents">Estado</th>
            </thead>
            <tbody>
                   <?php if ($ConfirmacionesRecepcionTurnos): ?>
                            <?php $i = 1;?>
                            <?php foreach ($ConfirmacionesRecepcionTurnos as $confirmacionturnos): ?>
           
                 <tr>
                <td class="counterCell"></td>
                <td><?php echo $confirmacionturnos->nombre; ?></td>
                <td><?php echo $confirmacionturnos->rut_completo; ?></td>
                <td><?php echo $confirmacionturnos->nombre_servicio; ?></td>
                <td></td>
              </tr>
             <?php $i++;?>
                            <?php endforeach;?>
        ...
        <div class="description description-footer">
          ...
          <p>Copyright &copy; 2021 <a href="http://creative-tim.com">CCR RIPLEY </a>
        </div>
      </div>
    </div>
  </div>
...
<div class="fixed-plugin" style="top: 300px">
  <div class="dropdown open">
    ...
    <ul class="dropdown-menu">
      <li class="header-title">Colores</li>
