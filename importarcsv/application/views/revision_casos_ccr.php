...
<h2 align="center">ultimos casos marcados</h2>
...
$(document).ready(function(){
	...
	$('#import_csv').on('submit', function(event){
		...
		$.ajax({
			...
			processData:false,
			beforeSend:function(){
				$('#import_csv_btn').html('Importando y marcando casos');
			},
			success:function(data)
			{
				$('#import_csv')[0].reset();
				$('#import_csv_btn').attr('disabled', false);
				$('#import_csv_btn').html('Importacion y marcación de casos realizada');
